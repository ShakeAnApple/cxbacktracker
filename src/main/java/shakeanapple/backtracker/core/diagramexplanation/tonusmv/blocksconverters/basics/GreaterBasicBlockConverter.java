...
import shakeanapple.backtracker.core.diagramexplanation.model.basiccomponents.logic.GreaterFunctionBlockBasic;
import shakeanapple.backtracker.core.diagramexplanation.tonusmv.*;

public class GreaterBasicBlockConverter extends NusmvBasicBlockConverterBase {
    private GreaterFunctionBlockBasic block;
    public GreaterBasicBlockConverter(GreaterFunctionBlockBasic block) {
        super(block);
        this.block = block;
    }
