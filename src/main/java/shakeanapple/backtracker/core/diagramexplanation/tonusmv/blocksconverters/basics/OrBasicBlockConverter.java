...
import shakeanapple.backtracker.core.diagramexplanation.model.basiccomponents.logic.OrFunctionBlockBasic;
import shakeanapple.backtracker.core.diagramexplanation.tonusmv.*;

public class OrBasicBlockConverter extends NusmvBasicBlockConverterBase {
    private OrFunctionBlockBasic block;

    public OrBasicBlockConverter(OrFunctionBlockBasic block) {
        super(block);
        this.block = block;
    }
