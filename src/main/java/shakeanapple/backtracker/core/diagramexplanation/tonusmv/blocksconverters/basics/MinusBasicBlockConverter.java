...
public class MinusBasicBlockConverter extends NusmvBasicBlockConverterBase {
    private MinusFunctionBlockBasic block;
    public MinusBasicBlockConverter(MinusFunctionBlockBasic block) {
        super(block);
        this.block = block;
    }
