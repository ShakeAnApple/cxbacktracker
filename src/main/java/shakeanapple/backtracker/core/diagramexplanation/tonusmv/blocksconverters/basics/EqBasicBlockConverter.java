...
import shakeanapple.backtracker.core.diagramexplanation.model.basiccomponents.logic.EqFunctionBlockBasic;
import shakeanapple.backtracker.core.diagramexplanation.tonusmv.*;

public class EqBasicBlockConverter extends NusmvBasicBlockConverterBase {
    private EqFunctionBlockBasic block;
    public EqBasicBlockConverter(EqFunctionBlockBasic block) {
        super(block);
        this.block = block;
    }
