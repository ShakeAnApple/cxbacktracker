...
public class ModFunctionBlockBasic extends BinOpFunctionBlockBasic {
    public ModFunctionBlockBasic(InputVariable<IntegerValueHolder> left, InputVariable<IntegerValueHolder> right, OutputVariable<IntegerValueHolder> output) {
        super("Mod", left, right, output);
    }
