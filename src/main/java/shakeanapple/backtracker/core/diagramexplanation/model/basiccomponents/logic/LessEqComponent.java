...
public class LessEqComponent extends BinOpComponent<IntegerValueHolder, BooleanValueHolder> {
    protected LessEqComponent(InputVariable<IntegerValueHolder> left, InputVariable<IntegerValueHolder> right, OutputVariable<BooleanValueHolder> res) {
