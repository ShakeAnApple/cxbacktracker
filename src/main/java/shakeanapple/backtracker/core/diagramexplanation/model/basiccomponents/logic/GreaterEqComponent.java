...
public class GreaterEqComponent extends BinOpComponent<IntegerValueHolder, BooleanValueHolder> {
    protected GreaterEqComponent(InputVariable<IntegerValueHolder> left, InputVariable<IntegerValueHolder> right, OutputVariable<BooleanValueHolder> res) {
