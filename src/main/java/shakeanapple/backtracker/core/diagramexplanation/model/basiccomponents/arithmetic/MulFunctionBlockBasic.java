...
public class MulFunctionBlockBasic extends BinOpFunctionBlockBasic {
    public MulFunctionBlockBasic(InputVariable<IntegerValueHolder> left, InputVariable<IntegerValueHolder> right, OutputVariable<IntegerValueHolder> output) {
        super("Mul", left, right, output);
    }
