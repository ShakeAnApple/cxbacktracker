...
public class OrComponent extends BooleanComponent {

    private final OutputVariable<BooleanValueHolder> result;

    protected OrComponent(List<InputVariable<BooleanValueHolder>> inputs, OutputVariable<BooleanValueHolder> res) {
