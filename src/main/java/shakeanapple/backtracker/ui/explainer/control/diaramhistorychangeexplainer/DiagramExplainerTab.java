...
//        FunctionBlockComplex diagram = FunctionBlockComplex.parse(Context.instance().getDiagramPath());
        ...
        this.diagramOutputExplainer = new DiagramChangeHistoryExplainer(diagram);
    }
    ...
    public List<Cause> explainCause(String varName, List<String> blockPath, int timestamp) {
        ...
        ChangeExplanationItem expRes = this.diagramOutputExplainer.explainChangeHistory(varName, blockPath, timestamp);
